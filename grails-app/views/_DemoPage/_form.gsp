...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myDate', 'error')} ">
    ...
    <div>
        <bs:datePicker class="form-control" name="myDate" precision="day" value="${_DemoPageInstance?.myDate}"
                       noSelection="['': '']"/>
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myFloat', 'error')} required">
    ...
    <div>
        <g:field class="form-control" type="number" name="myFloat" step="any" required=""
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myDouble', 'error')} required">
    ...
    <div>
        <g:field class="form-control" type="number" name="myDouble" step="any" required=""
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myTimeZone', 'error')} ">
    ...
    <div>
        <g:timeZoneSelect class="form-control" name="myTimeZone" value="${_DemoPageInstance?.myTimeZone}"
                          noSelection="['': '']"/>
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myLocale', 'error')} ">
    ...
    <div>
        <g:localeSelect class="form-control" name="myLocale" value="${_DemoPageInstance?.myLocale}"
                        noSelection="['': '']"/>
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myCurrency', 'error')} ">
    ...
    <div>
        <g:currencySelect class="form-control" name="myCurrency" value="${_DemoPageInstance?.myCurrency}"
                          noSelection="['': '']"/>
...
<div class="${hasErrors(bean: _DemoPageInstance, field: 'myEnum', 'error')} required">
    ...
    <div>
        <g:select class="form-control" name="myEnum" from="${kickstart._DemoPage$Suit?.values()}"
                  keys="${kickstart._DemoPage$Suit.values()*.name()}" required=""
