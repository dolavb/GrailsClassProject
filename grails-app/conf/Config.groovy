...
grails.project.groupId = com.blabha // change this to alter the default package name and Maven publishing destination
...
grails.resources.adhoc.patterns = ['/images/*', '/css/*', '/js/*', '/img/*', '/fonts/*', '/plugins/*', '/bootstrap/*', '/dist/*']
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.blabha.security.User'
