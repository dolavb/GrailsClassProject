...
/*
 * Coppied from https://github.com/joergrech/KickstartWithBootstrap; application was first created with the plugin
 * but conflict with other plugin made it more simple to just remove the kickstrart plugin and to keep only what was
 * required
 * */
